...
export default function EResourcesPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#8B9CF8]/10 via-[#5A63C4]/5 to-[#1E1D3A]/10">
      {/* Progress Bar */}
      <motion.div
        className="fixed top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#8B9CF8] via-[#5A63C4] to-[#1E1D3A] origin-left z-50"
        style={{ scaleX }}
      />

      {/* Header */}
      <motion.header
        className="bg-[#1E1D3A]/90 backdrop-blur-md border-b border-[#5A63C4]/50 sticky top-0 z-40 shadow-md"
        initial={{ y: -100 }}
        animate={{ y: 0 }}
          ...
          <Link href="/" className="flex items-center space-x-3">
            ...
            >
              <img
                src="/logo/rabiu.jpeg"
                alt="Logo"
                className="h-16 w-16 object-cover rounded-full drop-shadow-lg"
              />
            </motion.div>

            <div className="flex flex-col">
              <span className="text-xl font-bold text-white">Dr. Rabiu Musa</span>
              <span className="text-sm text-white">Kwankwaso Library</span>
            </div>
          </Link>


          <a
            href="https://library.khairun.edu.ng/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Button className="text-xs sm:text-sm italic tracking-wide
            bg-[#5A63C4] text-white px-3 sm:px-4 py-2 rounded-lg 
            shadow-sm hover:bg-[#1E1D3A] transition-colors w-fit">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          <motion.div
            className="inline-flex items-center px-4 py-2 bg-[#8B9CF8]/20 text-[#1E1D3A] rounded-full text-sm font-medium mb-6"
            initial={{ opacity: 0, scale: 0.8 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.6, delay: 0.2 }}
          >
            <Database className="w-4 h-4 mr-2 text-[#5A63C4]" />
            Digital Resources Portal
          </motion.div>

          <h1 className="text-5xl md:text-7xl font-bold text-[#1E1D3A] mb-6 tracking-tight">
            Electronic{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#8B9CF8] via-[#5A63C4] to-[#1E1D3A]">
              Resources
            </span>
          </h1>
          ...
          >
            <div className="text-center">
              <div className="text-3xl font-bold text-[#5A63C4]">10M+</div>
              <div className="text-sm text-gray-600">Electronic Volumes</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-[#8B9CF8]">15,000+</div>
              <div className="text-sm text-gray-600">Academic Journals</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-[#1E1D3A]">500+</div>
              <div className="text-sm text-gray-600">Databases</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-[#5A63C4]">24/7</div>
        ...
        <motion.div
          className="bg-white rounded-2xl p-8 shadow-lg border border-[#8B9CF8]/30 mb-12"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="flex flex-col lg:flex-row gap-6 items-center">
            ...
            <div className="flex-1 relative">
              ...
              <Input
                ...
                className="pl-10 h-12 text-lg border-gray-200 focus:border-[#5A63C4] focus:ring-[#5A63C4]"
              />
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="h-12 px-4 border border-gray-200 rounded-lg focus:border-[#8B9CF8] focus:ring-[#8B9CF8] bg-white"
              >
          ...
          <div className="mt-6 pt-6 border-t border-gray-100">
            <p className="text-gray-600 text-center">
              Showing <span className="font-semibold text-[#5A63C4]">{filteredDatabases.length}</span> databases
              ...
              {searchTerm && (
                <span>
                  {" "}matching "<span className="font-semibold text-[#1E1D3A]">{searchTerm}</span>"
                </span>
              )}
            </p>
          </div>
        ...
        {filteredDatabases.length === 0 && (
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-[#1E1D3A] mb-2">No databases found</h3>
            ...
            <Button
              ...
              className="bg-[#5A63C4] hover:bg-[#1E1D3A] text-white"
            >
              Clear Filters
            </Button>
          </motion.div>
...
function DatabaseCard({ database, index }: { database: any; index: number }) {
  return (
    ...
    >
      ...
      <div className="bg-gradient-to-r from-[#5A63C4] to-[#1E1D3A] p-6 text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-start justify-between mb-4">
            ...
            <span className="bg-[#8B9CF8]/80 text-[#1E1D3A] px-3 py-1 rounded-full text-sm font-medium">
              {database.category}
            </span>
          </div>
          <h3 className="text-2xl font-bold mb-2 text-[#8B9CF8]">{database.name}</h3>
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          {Object.entries(database.stats).map(([key, value]) => (
            <div key={key} className="text-center">
              <div className="text-2xl font-bold text-[#5A63C4]">{value as string}</div>
        ...
        {/* Features */}
        <div className="mb-6">
          <h4 className="font-semibold text-[#1E1D3A] mb-3 flex items-center">
            <Zap className="h-4 w-4 mr-2 text-[#5A63C4]" />
            Key Features
          </h4>
          <div className="grid grid-cols-2 gap-2">
            {database.features.map((feature: string, i: number) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className="w-1.5 h-1.5 bg-[#8B9CF8] rounded-full mr-2"></div>
                {feature}
              </motion.div>
            ))}
          </div>
        ...
        <div className="mb-6">
          <h4 className="font-semibold text-[#1E1D3A] mb-3 flex items-center">
            <BookOpen className="h-4 w-4 mr-2 text-[#8B9CF8]" />
            Subject Areas
          </h4>
          <div className="flex flex-wrap gap-2">
            {database.subjects.map((subject: string, i: number) => (
              <motion.span
                key={i}
                className="px-3 py-1 bg-[#5A63C4]/10 text-[#5A63C4] rounded-full text-sm font-medium hover:bg-[#5A63C4]/20 transition-colors duration-200"
                initial={{ opacity: 0, scale: 0.8 }}
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.98 }}
        >
          <Button className="w-full bg-gradient-to-r from-[#8B9CF8] to-[#5A63C4] hover:opacity-90 cursor-pointer text-white shadow-lg group">
      ...
      {/* Hover Effect Border */}
      <div className="absolute inset-0 rounded-2xl border-2 border-transparent group-hover:border-[#8B9CF8] transition-colors duration-300 pointer-events-none"></div>

      {/* Small logo at bottom right */}
      <img
        src="/logo/rabiu-bg.png"
        alt="Rabiu logo"
        className="absolute bottom-3 right-3 w-8 h-8 opacity-70"
      />
    </motion.div>
  )
}
